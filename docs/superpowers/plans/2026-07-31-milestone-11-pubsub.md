...
- [ ] **Step 1: Write `src/pubsub.rs` with `PubSub` struct, `publish`, `subscribe`, `unsubscribe`**
- [ ] **Step 2: Add unit tests for `PubSub`**

---

### Task 2: Implement `PUBLISH` command and connection subscribed mode

- [ ] **Step 1: Create `src/commands/pubsub.rs` with `PUBLISH` handler**
- [ ] **Step 2: Update `src/commands/mod.rs` dispatcher**
- [ ] **Step 3: Update `src/main.rs` connection loop for push delivery**
...
- [ ] **Step 1: Push `phase-11/pubsub` to GitHub**
- [ ] **Step 2: Open PR #11 against `phase-10/aof-persistence`**
